...
export function Shell({
  ...
  return (
    <div className="flex min-h-screen bg-cream-50">
      <aside className="hidden w-64 shrink-0 flex-col border-r border-cream-200 bg-white/80 p-4 backdrop-blur md:flex">
      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-10 flex items-center justify-between border-b border-cream-200 bg-white/80 px-6 py-3 backdrop-blur">
